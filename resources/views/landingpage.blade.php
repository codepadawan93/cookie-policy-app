...
<head>
    ...
    <!-- Core Stylesheet -->
    <link href="./vendor/landingpage/style.css" rel="stylesheet">

    <!-- Responsive CSS -->
    <link href="./vendor/landingpage/css/responsive.css" rel="stylesheet">
...
<body>
    ...
    <!-- Jquery-2.2.4 JS -->
    <script src="./vendor/landingpage/js/jquery-2.2.4.min.js"></script>
    <!-- Popper js -->
    <script src="./vendor/landingpage/js/popper.min.js"></script>
    <!-- Bootstrap-4 Beta JS -->
    <script src="./vendor/landingpage/js/bootstrap.min.js"></script>
    <!-- All Plugins JS -->
    <script src="./vendor/landingpage/js/plugins.js"></script>
    <!-- Slick Slider Js-->
    <script src="./vendor/landingpage/js/slick.min.js"></script>
    <!-- Footer Reveal JS -->
